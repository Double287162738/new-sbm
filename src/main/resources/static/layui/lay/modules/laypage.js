    ...
    u.prototype.type = function() {
        ...
        u.prototype.view = function() {
            ...
            a.curr > a.pages && (a.curr = a.pages),
                ...
                a.prev = "prev" in a ? a.prev: "Last page",
                a.next = "next" in a ? a.next: "Next page";
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t: 1)) : 1,
                i = {
                    ...
                    count: '<span class="layui-laypage-count">lines： ' + a.count + " </span>",
                    limit: function() {
                    ...
                    skip: function() {
                        return ['<span class="layui-laypage-skip">Jump to page', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '&#x9875;<button type="button" class="layui-laypage-btn">OK</button>', "</span>"].join("")
                    } ()
                };
