                    ...
                    a.layBody.on("click", "td",
                        function(e) {
                            ...
                            if (!i.data("off") && a) {
                                //乔永宝修改2018-11-10
                                var n;
                                // if(i.data("field")=="Estimate"){
                                //     n = t('<input type="number" class="layui-input special-estimate ' + N + '">');
                                // }else {
                                    n = t('<input type="number" class="layui-input ' + N + '">');
                                // }
                                return n[0].value = i.data("content") || l.text(),
                                i.find("." + N)[0] || i.append(n),
                                    //乔永宝修改2018-11-19
                                    i.find("input").val(l.text().replace(/,/g,"")),
                                    n.focus(),
                                    void layui.stope(e)
                            }
                        }).on("mouseenter", "td",
